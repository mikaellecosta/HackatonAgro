...
mock_estacoes = [
    {
        'id': 1,
        'nome': 'Estação Norte',
        'area': 'Talhão 01 - Milho',
        'latitude': '-6.4011',
        'longitude': '-38.8578',
        'descricao': 'Estação dedicada ao acompanhamento do desenvolvimento do milho e das condições do solo.',
        'status': 'Ativa',
    ...
    },
    {
        ...
        'latitude': '-6.3984',
        'longitude': '-38.8421',
        'descricao': 'Monitora a umidade e a temperatura do talhão de soja durante o ciclo de cultivo.',
        'status': 'Ativa',
    ...
    },
    {
        ...
        'latitude': '-6.4147',
        'longitude': '-38.8652',
        'descricao': 'Acompanha as condições do pasto e indica períodos de baixa disponibilidade de água.',
        'status': 'Atenção',
